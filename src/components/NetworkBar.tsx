...
export default function NetworkBar() {
  return (
    <div className="border-b border-white/10 bg-[#101626] text-white">
      <div className="mx-auto flex h-9 max-w-[1280px] items-center justify-between gap-3 px-6 text-[11px]">
        <a
        ...
        <div className="flex min-w-0 items-center gap-3 overflow-x-auto">
          ...
          <a
            ...
            className="whitespace-nowrap rounded-full border border-white/15 px-2.5 py-1 text-white/80 transition-colors hover:border-[#00E5FF] hover:text-[#00E5FF]"
          >
            Repo
          </a>
        </div>
